...
from hanks_lab_to_nwb.hanks_task import HanksTaskNWBConverter
...
def session_to_nwb(data_dir_path: Union[str, Path], output_dir_path: Union[str, Path], stub_test: bool = False):
    ...
    converter = HanksTaskNWBConverter(source_data=source_data)
    ...
    editable_metadata_path = Path(__file__).parent / "hanks_task_metadata.yaml"
